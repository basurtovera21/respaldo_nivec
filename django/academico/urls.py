...
urlpatterns = [
    ...
    path("paralelos/consolidado-excel/", views.consolidado_paralelos_excel, name="consolidado_paralelos_excel"),
    path("paralelos/estudiantes-excel/", views.consolidado_estudiantes_excel, name="consolidado_estudiantes_excel"),
